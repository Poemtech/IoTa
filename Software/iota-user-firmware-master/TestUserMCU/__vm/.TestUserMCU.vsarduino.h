/* 
	...
	Hardware: IoTa, Platform=iota, Package=iota-user-firmware-master
*/
...
#define USE_HOLOGRAM_CLOUD
#define FSL_OSA_BM_TIMER_CONFIG 2
#define ARDUINO 108010
#define ARDUINO_IOTA
#define ARDUINO_ARCH_IOTA
#define FSL_OSA_BM_TIMER_CONFIG 2
